# Support for Output Descriptors in Usfranc Core

Since Usfranc Core v0.17, there is support for Output Descriptors. This is a
...
existing Usfranc Core wallets, a convenience function `combo` is
