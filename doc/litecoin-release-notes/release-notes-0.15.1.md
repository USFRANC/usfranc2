Usfranc Core version *0.15.1* is now available from:

  <https://download.usfranc.org/usfranc-0.15.1/>
...
A number of changes to the way Usfranc Core deals with peer connections and invalid blocks
