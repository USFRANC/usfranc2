...
"""Verify that starting usfranc with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start usfranc with -h for help text")
        ...
        self.log.info("Start usfranc with -version for version information")
        ...
        self.log.info("Start usfrancd with -fakearg to make sure it does not start")
