...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " usfranc-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  usfranc-tx [options] <hex-tx> [commands]  Update hex-encoded usfranc transaction\n" +
            "or:     usfranc-tx [options] -create [commands]   Create hex-encoded usfranc transaction\n" +
            "\n";
